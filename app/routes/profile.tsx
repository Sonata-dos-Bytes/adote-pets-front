    ...
    const handleSubmitEdit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editFormData.password && !editFormData.oldPassword) {
                throw new Error('Você precisa informar a senha antiga para alterar a senha');
            }

            if (editFormData.password && editFormData.password !== editFormData.passwordConfirmation) {
                        ...
                        <form onSubmit={handleSubmitEdit} className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleEditFormChange('avatar', e.target.files?.[0] || null)}
                                    className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                                />
                            ...
                            <div className="border-t border-gray-200 pt-4 mt-4">
                                <p className="text-sm font-semibold text-gray-700 mb-3">Alterar Senha (opcional)</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleEditFormChange('oldPassword', e.target.value)}
                                    className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleEditFormChange('passwordConfirmation', e.target.value)}
                                    className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
